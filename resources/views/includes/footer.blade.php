    ...
    <div class="footer-content">
        <div class="footer-grid">
            ...
            <div class="footer-brand-section">
                <div class="footer-brand">
                    <div class="logo-wrapper">
                        <img id="logo_footer" src="{{ asset('/asset/img/Kabar_Utamo.png') }}" alt=" Logo">
                    </div>
                </div>
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    @foreach (\App\Models\Categories::take(6)->get() as $category)
        ...
        <div class="newsletter-section">
            <div class="newsletter-header">
                <div class="newsletter-number">04</div>
                <h3 class="newsletter-title">BERLANGGANAN NEWSLETTER</h3>
            </div>
            <div class="newsletter-content">
                <p class="newsletter-description">Dapatkan berita terkini langsung ke email Anda setiap hari</p>
                <div class="newsletter-form">
                    <input type="email" placeholder="Masukkan alamat email Anda" class="newsletter-input">
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-content">
                ...
                <div class="footer-bottom-links">
                    ...
                    <span class="separator"></span>
                    <a href="#" class="footer-bottom-link">DISCLAIMER</a>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    .footer-top-bar {
        height: 6px;
        background: linear-gradient(90deg, var(--primary-blue) 0%, var(--primary-blue-light) 50%, var(--accent-blue) 100%);
        width: 100%;
    }
